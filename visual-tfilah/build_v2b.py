...
# ------------------------------------------------------------------- fix-ups
LOGO_XY = (15511536, 8833104, 2094230, 1243584)   # 16.96", 9.66", 2.29x1.36 — v1d's position
...
def global_fixes(x):
    ...
    # 4. Bottom-align the translation box so its last line sits at the same height
